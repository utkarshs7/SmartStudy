...
<div class="diy-nav js-diy-nav" id="nav">
	...
	<div class="diy-nav__panel diy-nav__panel--mobile-search js-panel js-panel-search hidden">
		<div class="diy-nav__container">
                    <form class="form-inline search-panel" method="get" action="http://www.google.com/psearch" role="form" target="_blank">
				<fieldset>
					<legend class="sr-only">search</legend>
					<input type="hidden" name="dsp" value='your-projects' target="_blank"/>
					<div class="form-group">
						<input class="form-control" type="text" name="psearch" title="search"
							placeholder="Search" value="" target="_blank"/>
					</div>
					<input class="sr-only" type="submit" value="search" target="_blank" />
			...
			<div class="login-panel clearfix ">
				...
				<span class="login-panel__content--logged-out">
					<span class="login-panel__row login-panel__row--login">
						...
						<a class="btn btn--header btn--header-large btn--login pull-left" href="Invalidate">Logout</a>
...
<div id="newFields"></div>
  ...
  $(function() {
    ...
    <br><br>
    <label style="padding-left: 50px; padding-right: 98px;"><b>EmailID</b></label>
    <input type="email" name="Useremail" id="user_email" style="width: 400px; height: 55px; resize: auto;">
    <br><br>
    <label style="padding-left: 50px; padding-right: 90px;"><b>Password</b></label>
    <intput type="password" name="Userpassword" id="user_password" style="width:400px; height: 55px; resize: auto;"
    <br><br>
...
String res="";
   ...
   if(Ue!=null&&QT!=null&&Pass!=null)
   {
    String query2 = "select Password from data where Email='"+Ue+"'";
    String query = "insert into adques (question,askeremail) values('"+QT+"','"+Ue+"')";
      ...
      //  try {
       Class.forName("com.mysql.jdbc.Driver");
       co1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/logintest","root","utkarsh123");
